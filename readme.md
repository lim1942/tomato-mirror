...
- 手机分配(限时：限定时间给用户分配手机，时间到期后收回分配)
- 分组管理(不限时：手机分组管理,可指定分组的手机授予用户)
- 列表投屏
- 无线投屏
- 摄像头投屏
- 音频播放
...
**只支持windows部署**  
### 下载
>#### 1.lite版本：[番茄投屏lite](!https://github.com/lim1942/tomato-mirror/releases/download/v1.0.0/tomato_mirror_lite1.0.0.zip)
>#### 2.pro版本：敬请期待...
